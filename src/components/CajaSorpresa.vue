<template>
    <Dialog v-model:visible="mostrarDialog" class="sorpresa" :style="{ width: '35rem' }"
        :breakpoints="{ '1199px': '75vw', '575px': '90vw' }" position="top" :modal="true" :draggable="false" @hide="cerrarDialog">
